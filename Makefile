...
lib/App/NDTools/INC/Struct/Path.pm:
	mkdir -p $(@D)
	wget -O $@ "http://st.aticpan.org/source/MIXAS/Struct-Path-0.72/lib/Struct/Path.pm"

lib/App/NDTools/INC/Struct/Path/PerlStyle.pm:
	mkdir -p $(@D)
	wget -O $@ "http://st.aticpan.org/source/MIXAS/Struct-Path-PerlStyle-0.71/lib/Struct/Path/PerlStyle.pm"
